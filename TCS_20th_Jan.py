...
class scholargrade:
    ...
    def calculate_grade(self, list, grade):
        ...
        if len(list) == 0:
            ...
            for i in list:
                ...
                if percentage > 80:
                    ...
                    assign_grade = "D"
                student_list = [i.scid, i.name,
                                i.state, assign_grade, total_marks]
        ...
        print(*self.scgrad1, sep="\n")  # Data of all students

        self.scgrad = sorted(self.scgrad, key=lambda x: (
            x['total_marks']), reverse=False)  # Data of students who got grade A
        return (self.scgrad)
